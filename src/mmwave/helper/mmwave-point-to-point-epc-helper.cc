...
MmWavePointToPointEpcHelper::AddX2Interface (Ptr<Node> enb1, Ptr<Node> enb2)
{
  ...
  // NB: this ns-3.27 tree uses the unified Queue MaxSize (QueueSize) attribute, not the legacy MaxPackets/MaxBytes.
  p2ph.SetQueue ("ns3::DropTailQueue", "MaxSize", StringValue ("1000000p"));
