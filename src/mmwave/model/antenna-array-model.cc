...
{
  NS_LOG_DEBUG("Setting antenna array layers to " << (int)currNumLayers);
...
void AntennaArrayModel::SetBeamformingVector (complexVector_t antennaWeights, Ptr<NetDevice> device)
{
  NS_FATAL_ERROR("Legacy function invoked, use hybrid beamforming methods instead");
}

void AntennaArrayModel::SetBeamformingVectorWithDelay (complexVector_t antennaWeights, Ptr<NetDevice> device)
{
  NS_FATAL_ERROR("Legacy function invoked, use hybrid beamforming methods instead");
}
...
AntennaArrayBasicModel::complexVector_t AntennaArrayModel::GetBeamformingVector ()
{
  NS_FATAL_ERROR("Legacy function invoked, use hybrid beamforming methods instead");
}
