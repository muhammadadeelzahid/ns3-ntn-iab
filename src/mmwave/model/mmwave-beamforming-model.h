...
public:
  ...
  /**
   ...
   /**
     ...
     // To-do: change the name to SetChannel
     /**
        ...
        */
     void SetSpectrumPropagationLossModel (Ptr<MmWave3gppChannel> spectrumPropagationLossModel);
...
public:
   ...
   * \param the target device
   */
  virtual AntennaArrayBasicModel::BeamformingVector DoDesignBeamformingVectorForDevice (Ptr<NetDevice> otherDevice, uint8_t layerInd);
...
//  void SetBeamformingVectorForDevice (Ptr<NetDevice> otherDevice, uint8_t layerInd = 0);//we do not need to override this function, only the call to the next one
   ...
   * \param the target device
   */
  virtual AntennaArrayBasicModel::BeamformingVector DoDesignBeamformingVectorForDevice (Ptr<NetDevice> otherDevice, uint8_t layerInd) override;
