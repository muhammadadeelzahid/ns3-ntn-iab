...
// methods of the scheduler called by the MmWaveUeMac class
class MmWaveUeMacCschedSapProvider
{
public:
  virtual ~MmWaveUeMacCschedSapProvider ();

  struct IabBackhaulSchedInfo
  {
...
template <class C>
class MemberMmWaveUeMacCschedSapProvider : public MmWaveUeMacCschedSapProvider
{
public:
  MemberMmWaveUeMacCschedSapProvider (C* owner);

  // inherited from LteAsSapUser
  virtual void IabBackhaulSchedNotify (const struct IabBackhaulSchedInfo& info);

private:
  MemberMmWaveUeMacCschedSapProvider ();
  C* m_owner;
};

template <class C>
MemberMmWaveUeMacCschedSapProvider<C>::MemberMmWaveUeMacCschedSapProvider (C* owner)
  : m_owner (owner)
{
}

template <class C>
MemberMmWaveUeMacCschedSapProvider<C>::MemberMmWaveUeMacCschedSapProvider ()
{
}
