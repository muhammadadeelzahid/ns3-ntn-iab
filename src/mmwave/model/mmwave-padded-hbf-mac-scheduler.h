...
*
*   			2020: Felipe Gomez Cuba <gomezcuba@gts.uvigo.es>
*
*/
...
class MmWavePaddedHbfMacScheduler : public MmWaveMacScheduler
{
public:
  ...
  MmWavePaddedHbfMacScheduler ();

  virtual ~MmWavePaddedHbfMacScheduler ();
  ...
  friend class MmWavePaddedHbfMacSchedSapProvider;
  friend class MmWavePaddedHbfMacCschedSapProvider;

  void SetMmWaveUeMacCschedSapProvider (MmWaveUeMacCschedSapProvider* sap);
  
  MmWaveUeMacCschedSapProvider* GetMmWaveUeMacCschedSapProvider ();
...
private:
  ...
  // IAB support (multi-layer)
  bool m_iabScheduler;
  bool m_split;
  uint32_t m_maxSchedulingDelay;
  MmWaveUeMacCschedSapProvider* m_iabBackahulSapProvider;

  std::vector<SfIabAllocInfo> m_iabBusySubframeAllocation;
...
public:
  ...
  bool CheckOverlapWithBusyResources(uint32_t symStart, uint32_t numSym, uint8_t layer=0);
