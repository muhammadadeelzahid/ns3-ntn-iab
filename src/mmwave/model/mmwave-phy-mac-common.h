...
public:
	...
	static bool CompareSlotAllocInfo(SlotAllocInfo slotAllocInfoA, SlotAllocInfo slotAllocInfoB)
	{
		return (slotAllocInfoA.m_dci.m_symStart < slotAllocInfoB.m_dci.m_symStart);
	};
