...
public:
	...
	void RegisterOtherEnb (uint16_t cellId, Ptr<MmWavePhyMacCommon> config, Ptr<NetDevice> enb);
...
private:
	...
	std::map<uint16_t, std::pair<Ptr<MmWavePhyMacCommon>, Ptr<NetDevice> > > m_registeredEnb;
